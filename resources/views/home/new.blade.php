          ...
          <!-- 图片画廊 -->
                  <ul data-am-widget="gallery" class="am-gallery am-avg-sm-3 am-avg-md-3 am-avg-lg-4 am-gallery-default" data-am-gallery="{ pureview: true }" >
                        ...
                        <div class="am-gallery-item">
                            <a href="{{asset('home/style/images/bing-1.jpg')}}" class="">
                              <img src="{{asset('home/style/images/bing-1.jpg')}}"  alt="远方 有一个地方 那里种有我们的梦想"/>
                      ...
                      <li>
                        <div class="am-gallery-item">
                            <a href="{{asset('home/style/images/bing-2.jpg')}}" class="">
                              <img src="{{asset('home/style/images/bing-2.jpg')}}"  alt="某天 也许会相遇 相遇在这个好地方"/>
                      ...
                      <li>
                        <div class="am-gallery-item">
                            <a href="{{asset('home/style/images/bing-3.jpg')}}" class="">
                              <img src="{{asset('home/style/images/bing-3.jpg')}}"  alt="不要太担心 只因为我相信"/>
                      ...
                      <li>
                        <div class="am-gallery-item">
                            <a href="{{asset('home/style/images/bing-4.jpg')}}" class="">
                              <img src="{{asset('home/style/images/bing-4.jpg')}}"  alt="终会走过这条遥远的道路"/>
          ...
          <div class="am-panel-group">
            ...
            <section class="am-panel am-panel-primary">
              ...
              <div class="am-panel-bd">
                <p class="am-thumbnail"><img src="{{asset('home/style/images/baqiye_erweima.jpg')}}"  alt="扒企业"></p>
              </div>
            </section>
